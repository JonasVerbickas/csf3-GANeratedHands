...
class Generator(nn.Module):
    def __init__(self):
        ...
        res_blocks = nn.Sequential(*list(resnet50.children())[:6])
        ...
        last = nn.Conv2d(64, 3, kernel_size=7, stride=1, padding=3, padding_mode="reflect")
        sigmoid = nn.Sigmoid()
        self.model = nn.Sequential(*[res_blocks, upsample_blocks, last, sigmoid])
...
class Resnet(nn.Module):
    ...
    def __init__(self, deconvolution=True, n_blocks=4):
